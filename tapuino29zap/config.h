...
#define TAPE_READ_PORT      PORTB
#define TAPE_READ_DDR       DDRB
#define TAPE_READ_PIN       1                // El pin9 es el bit1 del PORTB
...
#define TAPE_WRITE_PIN      0                // El pin8 es el bit 0 del PORTB//
